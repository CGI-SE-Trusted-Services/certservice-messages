...
* Smaller code cleanup to MessageHandler related code.
...
* Upgraded Tomcat to from 9.0.106 to 9.0.115
* Upgraded Commons IO from 2.19.0 to 2.21.0.

== Version 2511.1

=== Dependency upgrades

* Made msgSender components overall more stable.
* Upgraded OpenCSV from 5.11.1 to 5.12.0
* Upgraded IBM MQ from 9.4.3.0 to 9.4.4.0
* Upgraded Logback Classic Module from 1.5.18 to 1.5.20
