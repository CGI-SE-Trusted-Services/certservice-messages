...
class AutoEnrollPayloadParserSpec extends Specification {
    ...
    org.certificateservices.messages.sensitivekeys.jaxb.ObjectFactory sensitivekeysOf = new org.certificateservices.messages.sensitivekeys.jaxb.ObjectFactory()
