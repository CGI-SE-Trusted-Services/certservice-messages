...
import org.certificateservices.ca.pkimessages.jaxb.Attribute
...
class DefaultPKIMessageParserSpec extends Specification {
	...
	private static DummyPKIMessageSecurityProvider secprov = new DummyPKIMessageSecurityProvider();
