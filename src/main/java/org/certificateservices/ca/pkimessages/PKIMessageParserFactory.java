...
public class PKIMessageParserFactory {
	 ...
	 * @throws PKIMessageException if problems occurred creating a message parser.
	 */
	public static PKIMessageParser genPKIMessageParser(PKIMessageSecurityProvider securityProvider, Properties config) throws PKIMessageException{
		...
		try{
			...
			throw new PKIMessageException("Error creating PKI Message Parser: " + e.getMessage(),e);			
		}
	}
