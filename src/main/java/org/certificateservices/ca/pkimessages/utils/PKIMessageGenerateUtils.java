...
public class PKIMessageGenerateUtils {
	 ...
	 * @throws PKIMessageException if internal problems occurred converting the date.
	 */
	public static XMLGregorianCalendar dateToXMLGregorianCalendar(Date date) throws PKIMessageException{
		if(date == null){
			return null;
		}
		...
		try {
			...
			throw new PKIMessageException("Error generating XMLGregorianDate from Date : " + e.getMessage(),e);
		}
	}
	 ...
	 * @throws PKIMessageException if internal problems occurred converting the date.
	 */
	public static Date xMLGregorianCalendarToDate(XMLGregorianCalendar calendarDate) throws PKIMessageException{
