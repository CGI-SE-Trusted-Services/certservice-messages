...
public interface PKIMessageParser {
	 ...
	 * @throws PKIMessageException if configuration contained bad configuration of security provider.
	 */
	void init(PKIMessageSecurityProvider securityProvider, Properties config) throws PKIMessageException;
	 ...
	 * @throws PKIMessageException if internal state occurred when processing the PKIMessage
	 */
	PKIMessage parseMessage(byte[] messageData) throws IllegalArgumentException, PKIMessageException;
	 ...
	 * @throws PKIMessageException if internal state occurred when processing the PKIMessage
	 */
	byte[] genIssueTokenCredentialsRequest(String requestId, String destination, String organisation, TokenRequest tokenRequest) throws IllegalArgumentException, PKIMessageException;
	 ...
	 * @throws PKIMessageException if internal state occurred when processing the PKIMessage
	 */
	PKIMessageResponseData genIssueTokenCredentialsResponse(PKIMessage request, List<Credential> credentials, List<Credential> revokedCredentials) throws IllegalArgumentException, PKIMessageException;
	 ...
	 * @throws PKIMessageException if internal state occurred when processing the PKIMessage
	 */
	byte[] genChangeCredentialStatusRequest(String requestId, String destination, String organisation, String issuerId, String serialNumber, int newCredentialStatus, String reasonInformation)  throws IllegalArgumentException, PKIMessageException;
	 ...
	 * @throws PKIMessageException if internal state occurred when processing the PKIMessage
	 */
	PKIMessageResponseData genChangeCredentialStatusResponse(PKIMessage request, String issuerId, String serialNumber, int credentialStatus, String reasonInformation, Date revocationDate)  throws IllegalArgumentException, PKIMessageException;
	 ...
	 * @throws PKIMessageException if internal state occurred when processing the PKIMessage
	 */
	byte[] genGetCredentialRequest(String requestId, String destination, String organisation, String credentialSubType, String issuerId, String serialNumber)  throws IllegalArgumentException, PKIMessageException;
	 ...
	 * @throws PKIMessageException if internal state occurred when processing the PKIMessage
	 */
	PKIMessageResponseData genGetCredentialResponse(PKIMessage request, Credential credential) throws IllegalArgumentException, PKIMessageException;
	 ...
	 * @throws PKIMessageException if internal state occurred when processing the PKIMessage
	 */
	byte[] genGetCredentialStatusListRequest(String requestId, String destination, String organisation, String issuerId, Long serialNumber, String credentialStatusListType) throws IllegalArgumentException, PKIMessageException;
	 ...
	 * @throws PKIMessageException if internal state occurred when processing the PKIMessage
	 */
	PKIMessageResponseData genGetCredentialStatusListResponse(PKIMessage request, CredentialStatusList credentialStatusList) throws IllegalArgumentException, PKIMessageException;
	 ...
	 * @throws PKIMessageException if internal state occurred when processing the PKIMessage
	 */
	byte[] genGetIssuerCredentialsRequest(String requestId, String destination, String organisation, String issuerId) throws IllegalArgumentException, PKIMessageException;
	 ...
	 * @throws PKIMessageException if internal state occurred when processing the PKIMessage
	 */
	PKIMessageResponseData genGetIssuerCredentialsResponse(PKIMessage request, Credential issuerCredential) throws IllegalArgumentException, PKIMessageException;
	 ...
	 * @throws PKIMessageException if internal state occurred when processing the PKIMessage
	 */
	byte[] genIsIssuerRequest(String requestId, String destination, String organisation, String issuerId) throws IllegalArgumentException, PKIMessageException;
	 ...
	 * @throws PKIMessageException if internal state occurred when processing the PKIMessage
	 */
	PKIMessageResponseData genIsIssuerResponse(PKIMessage request, boolean isIssuer) throws IllegalArgumentException, PKIMessageException;
	 ...
	 */
	byte[] genIssueCredentialStatusListRequest(String requestId, String destination, String organisation, String issuerId, String credentialStatusListType, Boolean force, Date requestedValidFromDate, Date requestedNotAfterDate) throws IllegalArgumentException, PKIMessageException;
	 ...
	 * @throws PKIMessageException if internal state occurred when processing the PKIMessage
	 */
	PKIMessageResponseData genIssueCredentialStatusListResponse(PKIMessage request, CredentialStatusList credentialStatusList) throws IllegalArgumentException, PKIMessageException;
	 ...
	 * @throws PKIMessageException if internal state occurred when processing the PKIMessage
	 */
	byte[] genRemoveCredentialRequest(String requestId, String destination, String organisation, String issuerId, String serialNumber)  throws IllegalArgumentException, PKIMessageException;
	 ...
	 * @throws PKIMessageException if internal state occurred when processing the PKIMessage
	 */
	PKIMessageResponseData genRemoveCredentialResponse(PKIMessage request) throws IllegalArgumentException, PKIMessageException;
	 ...
	 * @throws PKIMessageException if internal state occurred when processing the PKIMessage
	 */
	byte[] genFetchHardTokenDataRequest(String requestId, String destination, String organisation, String tokenSerial, String relatedCredentialSerialNumber, String relatedCredentialIssuerId, Credential adminCredential)  throws IllegalArgumentException, PKIMessageException;
	 ...
	 * @throws PKIMessageException if internal state occurred when processing the PKIMessage
	 */
	PKIMessageResponseData genFetchHardTokenDataResponse(PKIMessage request, String tokenSerial, byte[] encryptedData)  throws IllegalArgumentException, PKIMessageException;
	 ...
	 * @throws PKIMessageException if internal state occurred when processing the PKIMessage
	 */
	byte[] genStoreHardTokenDataRequest(String requestId, String destination, String organisation, String tokenSerial, String relatedCredentialSerialNumber, String relatedCredentialIssuerId, byte[] encryptedData)  throws IllegalArgumentException, PKIMessageException;
	 ...
	 * @throws PKIMessageException if internal state occurred when processing the PKIMessage
	 */
	PKIMessageResponseData genStoreHardTokenDataResponse(PKIMessage request)  throws IllegalArgumentException, PKIMessageException;
	 ...
	 * @throws PKIMessageException if internal state occurred when processing the PKIMessage
	 */
	PKIMessageResponseData genPKIResponse(byte[] request, RequestStatus status, String failureMessage) throws IllegalArgumentException, PKIMessageException;
	 ...
	 * @throws PKIMessageException if internal state occurred when processing the PKIMessage
	 */
	PKIMessageResponseData genPKIResponse(byte[] request, RequestStatus status, String failureMessage, String destinationId) throws IllegalArgumentException, PKIMessageException;
	 ...
	 * @throws PKIMessageException if internal error occurred parsing the certificate.
	 */
	X509Certificate getSigningCertificate(byte[] request) throws IllegalArgumentException, PKIMessageException;
