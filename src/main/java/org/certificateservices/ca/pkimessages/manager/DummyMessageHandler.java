...
public class DummyMessageHandler implements MessageHandler{
	...
	public void init(Properties config, PKIMessageParser parser,
			MessageResponseCallback callback) throws PKIMessageException {
		this.parser = parser;
	...
	public void connect() throws PKIMessageException, IOException {
		
		
	}

	public void sendMessage(byte[] messageData) throws PKIMessageException,
	IOException {
	...
	public Object getConnectionFactory() throws PKIMessageException,
			IOException {
		throw new PKIMessageException("Not implemented");
	}
