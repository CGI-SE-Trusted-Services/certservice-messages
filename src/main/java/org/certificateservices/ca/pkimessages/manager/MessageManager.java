...
public interface MessageManager {
	 ...
	 * @throws PKIMessageException if there were an critical internal error at the server side, that wasn't related to communication problems.
	 */
	void init(Properties config, PKIMessageParser parser, String destination) throws IllegalArgumentException, IOException, PKIMessageException;
	 ...
	 * @throws PKIMessageException if there were an critical internal error at the server side, that wasn't related to communication problems.
	 */
	PKIMessage sendMessage(String requestId, byte[] request) throws IllegalArgumentException, IOException, PKIMessageException;
